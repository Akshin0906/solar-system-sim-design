#!/usr/bin/env python3
"""Verify readable-mode moon offsets clear enlarged parent bodies."""
...
def readable_moon_distance(
    ...
    fallback_distance = math.pow(semi_major_axis_km / 100_000, 0.74) * 0.72
    ...
    distance_in_parent_radii = semi_major_axis_km / parent_radius_km
    scaled_distance = (
        parent_radius
    ...
    return max(true_distance, fallback_distance, scaled_distance, minimum_distance)
